      ...
      <div class="sparkline11-list shadow-reset mg-t-30">
        <div class="sparkline11-hd">
          <div class="main-sparkline11-hd">
            ...
            <div class="sparkline11-outline-icon">
              ...
              <span class="sparkline11-collapse-close"><a href="/"><i class="fa fa-times"></i></a></span>
            </div>
          </div>
        </div>
        <div class="sparkline11-graph">
          <div class="input-knob-dial-wrap">
            <div class="row">
              <div class="col-lg-12">
                <form action="{{ route('mobil.insert') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-block">Jual Mobil</button>
                  </div>
                </form>
              </div>
            </div>
